...
```
authorization: Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJBZWdpc0FwaSIsImV4cCI6MTU2MDc2NTc3NSwiaWF0IjoxNTU4MzQ2NTc1LCJpc3MiOiJBZWdpc0FwaSIsImp0aSI6ImNhMTk1ZGZmLWI4ZjUtNDExMy05Yzg1LTRiY2JkYjdiOTRjOCIsIm5iZiI6MTU1ODM0NjU3NCwic3ViIjoiMTYiLCJ0eXAiOiJhY2Nlc3MifQ.jaR5tlJ5tNd3KlpXS1NE2nFTMS7uomr8M9IJkDO0lprs1zbjMg7-Iimip_J1SMWfLoSzgb50EqE-1suHlStOOg
```
...
x-request-id: 2mg5nt0vgas41h0cq00000e2
...
* __Request headers:__
```
authorization: Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJBZWdpc0FwaSIsImV4cCI6MTU2MDc2NTc3OCwiaWF0IjoxNTU4MzQ2NTc4LCJpc3MiOiJBZWdpc0FwaSIsImp0aSI6IjNjYTFlMjQ2LTJiYjMtNGU1Ny1hMTM2LWFlMDJjOTNkODZlYSIsIm5iZiI6MTU1ODM0NjU3Nywic3ViIjoiMTYiLCJ0eXAiOiJhY2Nlc3MifQ.kXtdWkyCogBbMVuyojoXJmT4p1SxPas_8uCBsi3jFai1zwnojUWVzcyiSkGKqjeU03KEbzsIAvi64DawEhHCXw
```
...
```
cache-control: max-age=0, private, must-revalidate
x-request-id: 2mg5nt7dad8o1mbdv40001i1
content-type: application/json; charset=utf-8
```
* __Response body:__
```json
...
* __Request headers:__
```
authorization: Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJBZWdpc0FwaSIsImV4cCI6MTU2MDc2NTc3NiwiaWF0IjoxNTU4MzQ2NTc2LCJpc3MiOiJBZWdpc0FwaSIsImp0aSI6IjU1MDA5MjlkLTNjMzYtNDBmNy05ODkyLWU1N2U1MzRlNzgxZiIsIm5iZiI6MTU1ODM0NjU3NSwic3ViIjoiMTYiLCJ0eXAiOiJhY2Nlc3MifQ.WZTCbUPxKPhMTfcjQHsnoCqxGte0to3GD-pu83DlkegIi8hoLPrQ1EgshIx5edcNll1-T93LoShB0Wkf3km_bg
```
...
```
cache-control: max-age=0, private, must-revalidate
x-request-id: 2mg5nt48omus0pon1k0000g2
content-type: application/json; charset=utf-8
```
* __Response body:__
```json
[
  {
    ...
    "start_at": "2019-03-28T10:41:14.385401",
    "standstills": 11,
    "risk_score": 75,
    "map_visible": false,
    "gps_track": {
...
* __Request headers:__
```
authorization: Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJBZWdpc0FwaSIsImV4cCI6MTU2MDc2NTc3MywiaWF0IjoxNTU4MzQ2NTczLCJpc3MiOiJBZWdpc0FwaSIsImp0aSI6IjlhMjk2MWI5LWM1N2QtNGJlNC05MWQxLWI1ODllMmNjY2RhYSIsIm5iZiI6MTU1ODM0NjU3Miwic3ViIjoiMTYiLCJ0eXAiOiJhY2Nlc3MifQ.i2pQqMHIup0J3mQK1KbCaWzvEqWyvQAHTboVBXOjD-vfY11H0U62dt9gchS1wP863FMpJCu-CqdYHikhiW6lEw
```
...
```
cache-control: max-age=0, private, must-revalidate
x-request-id: 2mg5nstihmjk0kp5500000c3
content-type: application/json; charset=utf-8
```
* __Response body:__
```json
