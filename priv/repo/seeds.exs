...
Enum.each(trip, fn (trip) -> AegisApi.Repo.insert(trip) end)
...
Enum.each(event, fn (event) -> AegisApi.Repo.insert(event) end)
...
Enum.each(measurement, fn (measurement) -> AegisApi.Repo.insert(measurement) end)
